...
from unigate.schemas.group import GroupRead, GroupReadWithStudents
...
def get_groups(
    session: SessionDep, current_user: Student = Depends(get_current_user(wanted_model=Student)),
) -> list[Group]:
